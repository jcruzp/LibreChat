...
export default {
  ...
  com_nav_lang_brazilian_portuguese: 'Portugués Brasileño',
  com_nav_lang_russian: 'Ruso',
  com_nav_lang_japanese: 'Japonés',
  com_nav_lang_swedish: 'Sueco',
  ...
  com_nav_lang_indonesia: 'Indonesio',
  com_nav_lang_hebrew: 'Hebreo',
  ...
  com_endpoint_preset_clear_all_confirm: '¿Está seguro de que desea eliminar todos sus presets?',
  com_endpoint_preset_import: 'Preset importado!',
  com_endpoint_preset_import_error: 'Hubo un error al importar su preset. Por favor, inténtelo de nuevo.',
  com_endpoint_preset_save_error: 'Hubo un error al guardar su preset. Por favor, inténtelo de nuevo.',
  com_endpoint_preset_delete_error: 'Hubo un error al eliminar su preset. Por favor, inténtelo de nuevo.',
  com_endpoint_preset_default_removed: 'ya no es el preset predeterminado.',
  com_endpoint_preset_default_item: 'Predeterminado:',
  com_endpoint_preset_default_none: 'No hay presets predeterminados activos.',
  ...
  com_endpoint_use_active_assistant: 'Usar asistente activo',
  ...
  com_nav_info_code_artifacts: 'Habilita la visualización de artefactos de código experimentales junto al chat',
  com_ui_include_shadcnui: 'Incluir instrucciones de componentes shadcn/ui',
  com_nav_info_include_shadcnui: 'Si está habilitado, se incluirán instrucciones para usar componentes shadcn/ui. shadcn/ui es una colección de componentes reutilizables construidos utilizando Radix UI y Tailwind CSS. Nota: estas son instrucciones extensas, solo debe habilitarlas si es importante para usted informar al LLM de las importaciones y componentes correctos. Para más información sobre estos componentes, visite: https://ui.shadcn.com/',
  com_ui_custom_prompt_mode: 'Modo de prompt personalizado',
  com_nav_info_custom_prompt_mode: 'Si está habilitado, el prompt predeterminado del sistema de artefactos no se incluirá. Todas las instrucciones para generar artefactos deben proporcionarse manualmente en este modo.',
  com_ui_artifact_click: 'Haga clic para abrir',
  com_a11y_start: 'El AI ha comenzado su respuesta.',
  com_a11y_ai_composing: 'El AI todavía está componiendo.',
  com_a11y_end: 'El AI ha terminado su respuesta.',
  com_error_moderation: 'Error de moderación',
